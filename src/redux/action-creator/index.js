...
export const fetchAdminBids = (bidId = null, jobPostId = null, clientName = null, bidderName = null, biddingStatus = null, workStatus = null) => ({
    type: FETCH_ADMIN_BIDS,
    bidId,
    jobPostId,
    clientName,
    bidderName,
...
export const fetchAdminBidsSuccess = (bids) => ({
    type: FETCH_ADMIN_BIDS_SUCCESS,
    bids,
});

export const changeShowPopupBool = (showPopup) => ({
    type: SHOW_POPUP_BOOL,
    showPopup
});
