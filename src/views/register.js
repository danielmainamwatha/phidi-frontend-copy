                ...
                <div class="login-register-page">
                    ...
                    <form method="post" id="register-account-form" autoComplete="off" onSubmit={formik.handleSubmit}>{
                        ...
                        <div class="input-with-icon-left">
                            ...
                            <input type="text" class="input-text with-border" name="name" id="name" placeholder="First Name" {...formik.getFieldProps('name')}/>
                        </div>
                        ...
                        <span style={{fontSize: '10px', color: 'red'}}>{formik.errors.nationality}</span>
                        : null}
                        <div class="input-with-icon-left">
                            <i class="icon-line-awesome-flag"></i>
                            <input list="countries" type="text" class="input-text with-border" name="nationality" id="nationality" placeholder="Nationality" {...formik.getFieldProps('nationality')}/>
