                                        ...
                                        <div class="bidding-field">
                                            ...
                                            <div class="col-xl-11 col-lg-11">
                                                <div class="uploadButtonx">
                                                    <input onChange={this.handleBidSketches} id="uploadButtonAestheticSketch" class="uploadButton-inputx" type="file" name="bidSketches[]" accept="image/*, application/pdf" multiple="multiple" />
