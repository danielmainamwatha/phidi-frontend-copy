                ...
                <div class="col-xl-6 col-lg-6 wizard-div">
                        <div style={{minHeight: '100%'}} class="row align-items-center animate__animated animate__bounceInUp">
                            <div class="col-xl-12 col-lg-12">
                                ...
                                <input  onInput={handleInput} style={{paddingLeft: '8px', fontSize: '15px', height: '40px', border:'0.5px #a1a9e4 solid', marginBottom:'10px', color: 'white', background: 'transparent', padding: '50px'}} class="wizard-text-area-input objective-input" maxLength={100} placeholder="e.g an electric generator and battery, powered by campfire" defaultValue={objective}/>
                            </div>
