                ...
                <div class="left-side">
                    ...
                    <nav id="navigation">
                        <ul id="responsive">
                            ...
                            <li><Link to={'/admin/users'}> { historyPathname === '/admin/users' ? <span className="admin-nav-links"> Users </span> : <span>Users</span> } </Link>
                            </li>

                            <li><Link to={'/admin/messages'}>{ historyPathname === '/admin/messages' ? <span className="admin-nav-links"> Messages </span> : <span>Messages</span> } </Link>
                            </li>

                            <li><Link to={'/admin/bids'}>{ historyPathname === '/admin/bids' ? <span className="admin-nav-links"> Bids </span> : <span>Bids</span> } </Link>
                            </li>
